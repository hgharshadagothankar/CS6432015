...
<html>
 ...
 <body>
  ...
  <form:form method="POST" action="addEmployee.jsp">
      <table>
       <tr>
 ...
 <table align="left" border="1">
  ...
  <c:forEach items="${employees}" var="employee">
   <tr>
    ...
    <td align="center"><a href="addEmployee.jsp?id=${employee.id}">Edit</a> | <a href="addEmployee.jsp?id=${employee.id}">Delete</a></td>
   </tr>
  </c:forEach>
 </table>
</c:if>
